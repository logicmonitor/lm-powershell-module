function Build-EAISdtSchedule {
    ...
    try {
        ...
        function Read-TimezoneSelection {
            if (Get-LMUserConfirmation -Prompt 'Use local system timezone?' -DefaultAnswer 'y') {
                return $null
            }
        ...
        $previewPayload = Build-EAISdtScheduleFields -BoundParameters $scheduleParameters
