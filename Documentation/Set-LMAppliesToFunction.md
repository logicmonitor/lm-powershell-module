...
```
Set-LMAppliesToFunction -Id <string> [-NewName <string>] [-Description <string>]
 [-AppliesTo <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Name

```
Set-LMAppliesToFunction -Name <string> [-NewName <string>] [-Description <string>]
 [-AppliesTo <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
