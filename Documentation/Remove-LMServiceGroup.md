...
```
Remove-LMServiceGroup -Id <int> [-DeleteHostsandChildren <bool>] [-HardDelete <bool>] [-WhatIf]
...
```
Remove-LMServiceGroup -Name <string> [-DeleteHostsandChildren <bool>] [-HardDelete <bool>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
