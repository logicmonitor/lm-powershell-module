...
title: Remove-LMDynamicServiceInsight
---

# Remove-LMDynamicServiceInsight
...
```
Remove-LMDynamicServiceInsight [-Id] <string> [[-DeleteHard] <bool>] [-WhatIf] [-Confirm]
```

## DESCRIPTION

The Remove-LMDynamicServiceInsight function removes a LogicMonitor Service template by ID.

## EXAMPLES

### EXAMPLE 1

Remove-LMDynamicServiceInsight -Id 6
This example removes the LogicMonitor Service template with ID 6 using soft delete.

### EXAMPLE 2

Remove-LMDynamicServiceInsight -Id 6 -DeleteHard $true
