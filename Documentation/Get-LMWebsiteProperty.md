...
```
Get-LMWebsiteProperty -Id <int> [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```

### Name

```
Get-LMWebsiteProperty -Name <string> [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```
