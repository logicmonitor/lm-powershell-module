...
title: Get-LMDeviceLogSourceList
---
...
```
Get-LMDeviceLogSourceList -Id <int> [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```

### Name

```
Get-LMDeviceLogSourceList [-Name <string>] [-Filter <Object>] [-BatchSize <int>]
 [<CommonParameters>]
```
