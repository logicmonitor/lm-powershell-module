...
```
Get-LMEventSource [-BatchSize <int>] [<CommonParameters>]
```

### Id

```
Get-LMEventSource [-Id <int>] [-BatchSize <int>] [<CommonParameters>]
```

### Name

```
Get-LMEventSource [-Name <string>] [-BatchSize <int>] [<CommonParameters>]
```

### Filter

```
Get-LMEventSource [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```
