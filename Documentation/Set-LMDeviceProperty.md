...
```
Set-LMDeviceProperty -Id <int> -PropertyName <string> -PropertyValue <string> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Set-LMDeviceProperty -Name <string> -PropertyName <string> -PropertyValue <string> [-WhatIf]
