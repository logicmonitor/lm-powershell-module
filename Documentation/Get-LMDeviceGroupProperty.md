...
title: Get-LMDeviceGroupProperty
---
...
```
Get-LMDeviceGroupProperty -Id <int> [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```

### Name

```
Get-LMDeviceGroupProperty [-Name <string>] [-Filter <Object>] [-BatchSize <int>]
 [<CommonParameters>]
```
