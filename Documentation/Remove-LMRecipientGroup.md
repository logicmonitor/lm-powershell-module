...
```
Remove-LMRecipientGroup -Id <int> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Name

```
Remove-LMRecipientGroup -Name <string> [-WhatIf] [-Confirm] [<CommonParameters>]
```
