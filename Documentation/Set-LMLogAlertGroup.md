...
```
Set-LMLogAlertGroup -Id <int> [-NewName <string>] [-Description <string>] [-Query <string>]
 [-Partitions <string[]>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Name

```
Set-LMLogAlertGroup -Name <string> [-NewName <string>] [-Description <string>] [-Query <string>]
 [-Partitions <string[]>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Set-LMLogAlertGroup -InputObject <psobject> [-WhatIf] [-Confirm] [<CommonParameters>]
```
