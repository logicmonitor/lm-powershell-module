...
```
Get-LMDeviceNetflowPort -Id <int> [-Filter <Object>] [-StartDate <datetime>] [-EndDate <datetime>]
...
```
Get-LMDeviceNetflowPort [-Name <string>] [-Filter <Object>] [-StartDate <datetime>]
