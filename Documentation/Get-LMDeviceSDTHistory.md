...
```
Get-LMDeviceSDTHistory -Id <int> [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```

### Name

```
Get-LMDeviceSDTHistory [-Name <string>] [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```
