...
```
New-LMWebsiteSDT -Comment <string> [-Duration <int>] [-StartDate <datetime>] [-EndDate <datetime>]
 ...
 [-WebsiteId <string>] [-WebsiteName <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ScheduleWizard

```
New-LMWebsiteSDT [-Comment <string>] [-ScheduleWizard] [-Duration <int>] [-StartDate <datetime>]
 [-EndDate <datetime>] [-Timezone <string>] [-SdtType <string>] [-StartHour <int>]
 [-StartMinute <int>] [-EndHour <int>] [-EndMinute <int>] [-WeekDay <string[]>]
 [-WeekOfMonth <string>] [-DayOfMonth <int>] [-WebsiteId <string>] [-WebsiteName <string>] [-WhatIf]
...
ID of the website.
Provide either -WebsiteId or -WebsiteName.
