...
```
Remove-LMLogPartition -Id <int> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Name

```
Remove-LMLogPartition -Name <string> [-WhatIf] [-Confirm] [<CommonParameters>]
```
