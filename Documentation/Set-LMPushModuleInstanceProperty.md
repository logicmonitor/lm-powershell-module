...
title: Set-LMPushModuleInstanceProperty
---
...
```
Set-LMPushModuleInstanceProperty -DeviceId <int> -DataSourceName <string> -InstanceName <string>
 -PropertyName <string> -PropertyValue <string> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Name

```
Set-LMPushModuleInstanceProperty -DeviceName <string> -DataSourceName <string>
 -InstanceName <string> -PropertyName <string> -PropertyValue <string> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
