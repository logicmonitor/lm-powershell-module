...
```
Get-LMWebsiteSDTHistory -Id <int> [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```

### Name

```
Get-LMWebsiteSDTHistory [-Name <string>] [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```
