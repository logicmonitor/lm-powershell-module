...
```
Get-LMPropertySource [-BatchSize <int>] [<CommonParameters>]
```

### Id

```
Get-LMPropertySource [-Id <int>] [-BatchSize <int>] [<CommonParameters>]
```

### Name

```
Get-LMPropertySource [-Name <string>] [-BatchSize <int>] [<CommonParameters>]
```

### Filter

```
Get-LMPropertySource [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```
