...
```
Set-LMActionChain -Id <string> [-NewName <string>] [-Description <string>] [-Stages <psobject[]>]
...
```
Set-LMActionChain -Name <string> [-NewName <string>] [-Description <string>] [-Stages <psobject[]>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```
Set-LMActionChain -InputObject <psobject> [-WhatIf] [-Confirm] [<CommonParameters>]
```
