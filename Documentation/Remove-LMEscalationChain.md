...
title: Remove-LMEscalationChain
---
...
```
Remove-LMEscalationChain -Id <int> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Name

```
Remove-LMEscalationChain -Name <string> [-WhatIf] [-Confirm] [<CommonParameters>]
```
