...
```
Get-LMDeviceGroupDevice -Id <int> [-Filter <Object>] [-IncludeSubGroups <bool>] [-BatchSize <int>]
 [<CommonParameters>]
```
...
```
Get-LMDeviceGroupDevice [-Name <string>] [-Filter <Object>] [-IncludeSubGroups <bool>]
