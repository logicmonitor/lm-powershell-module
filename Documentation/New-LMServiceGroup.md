...
```
New-LMServiceGroup -Name <string> -ParentGroupId <int> [-Description <string>]
 [-Properties <hashtable>] [-DisableAlerting <bool>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### GroupName

```
New-LMServiceGroup -Name <string> -ParentGroupName <string> [-Description <string>]
 [-Properties <hashtable>] [-DisableAlerting <bool>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
