...
```
New-LMDeviceProperty -Id <int> -PropertyName <string> -PropertyValue <string> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
New-LMDeviceProperty -Name <string> -PropertyName <string> -PropertyValue <string> [-WhatIf]
