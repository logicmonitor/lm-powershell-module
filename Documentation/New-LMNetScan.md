...
New-LMNetscan [-CollectorId] <string> [-Name] <string> [[-Description] <string>]
 [[-ExcludeDuplicateType] <string>] [[-IgnoreSystemIpDuplicates] <bool>] [[-Method] <string>]
 [[-NextStart] <string>] [[-NextStartEpoch] <string>] [[-NetScanGroupId] <string>]
 [[-Schedule] <psobject>] [-SubnetRange] <string> [[-CredentialGroupId] <string>]
 [[-CredentialGroupName] <string>] [[-ChangeNameToken] <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
