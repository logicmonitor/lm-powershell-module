...
```
Set-LMNetscanGroup [-Id <int>] [-NewName <string>] [-Description <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Set-LMNetscanGroup [-Name <string>] [-NewName <string>] [-Description <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
