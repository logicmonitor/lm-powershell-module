...
```
Get-LMDeviceSDT -Id <int> [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```

### Name

```
Get-LMDeviceSDT [-Name <string>] [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```
