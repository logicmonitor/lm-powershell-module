...
```
Set-LMAPIToken -AdminId <int> -Id <int> [-Note <string>] [-Status <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Set-LMAPIToken -AdminName <string> -Id <int> [-Note <string>] [-Status <string>] [-WhatIf]
