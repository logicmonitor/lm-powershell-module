...
title: Set-LMDeviceGroupProperty
---
...
```
Set-LMDeviceGroupProperty -Id <int> -PropertyName <string> -PropertyValue <string> [-WhatIf]
...
```
Set-LMDeviceGroupProperty -Name <string> -PropertyName <string> -PropertyValue <string> [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
