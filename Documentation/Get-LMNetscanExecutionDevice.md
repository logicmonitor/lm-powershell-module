...
title: Get-LMNetscanExecutionDevice
---
...
```
Get-LMNetscanExecutionDevice -Id <int> -NspId <string> [-Filter <Object>] [-BatchSize <int>]
 [<CommonParameters>]
```
...
```
Get-LMNetscanExecutionDevice -NspName <string> [-Filter <Object>] [-BatchSize <int>]
 [<CommonParameters>]
```
