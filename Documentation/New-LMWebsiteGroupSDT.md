...
title: New-LMWebsiteGroupSDT
---

# New-LMWebsiteGroupSDT
...
```
New-LMWebsiteGroupSDT -Comment <string> [-Duration <int>] [-StartDate <datetime>]
 [-EndDate <datetime>] [-Timezone <string>] [-SdtType <string>] [-StartHour <int>]
 [-StartMinute <int>] [-EndHour <int>] [-EndMinute <int>] [-WeekDay <string[]>]
 [-WeekOfMonth <string>] [-DayOfMonth <int>] [-WebsiteGroupId <string>] [-WebsiteGroupName <string>]
...
```
New-LMWebsiteGroupSDT [-Comment <string>] [-ScheduleWizard] [-Duration <int>]
...
ID of the website group.
Provide either -WebsiteGroupId or -WebsiteGroupName.
