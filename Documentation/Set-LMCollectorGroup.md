...
```
Set-LMCollectorGroup [-Id <int>] [-NewName <string>] [-Description <string>]
 [-Properties <hashtable>] [-AutoBalance <bool>] [-AutoBalanceInstanceCountThreshold <int>]
...
```
Set-LMCollectorGroup [-Name <string>] [-NewName <string>] [-Description <string>]
 [-Properties <hashtable>] [-AutoBalance <bool>] [-AutoBalanceInstanceCountThreshold <int>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
