...
```
Remove-LMPropertysource -Id <int> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Name

```
Remove-LMPropertysource -Name <string> [-WhatIf] [-Confirm] [<CommonParameters>]
```
