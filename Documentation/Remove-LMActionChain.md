...
title: Remove-LMActionChain
---

# Remove-LMActionChain
...
```
Remove-LMActionChain -Id <int> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Name

```
Remove-LMActionChain -Name <string> [-WhatIf] [-Confirm] [<CommonParameters>]
```
