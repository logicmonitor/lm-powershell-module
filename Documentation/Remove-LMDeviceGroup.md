...
```
Remove-LMDeviceGroup -Id <int> [-DeleteHostsandChildren <bool>] [-HardDelete <bool>] [-WhatIf]
...
```
Remove-LMDeviceGroup -Name <string> [-DeleteHostsandChildren <bool>] [-HardDelete <bool>] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
