...
```
New-EAIEvent [-EventCi] <string> [-EventObject] <string> [-EventSource] <string>
 [-EventName] <string> [-EventDescription] <string> [[-Severity] <string>] [[-EventTime] <datetime>]
 [[-EventId] <string>] [[-EventDomain] <string>] [[-EventDetails] <string>]
 [[-EventCiLink] <string>] [[-EventNameLink] <string>] [[-EventSourceId] <string>]
 [[-EventSourceIdLink] <string>] [-SourceRecord] <Object> [[-Enrichments] <hashtable>]
 [<CommonParameters>]
```
...
The event domain for tenant-federated environments.
...
The event severity.
Accepts enum names (Critical, Major, Minor, Warning, Indeterminate, Clear) or integer values 0-5.
