...
title: New-LMDeviceDatasourceSDT
---
...
```
New-LMDeviceDatasourceSDT -Comment <string> -DeviceDataSourceId <string> [-Duration <int>]
...
```
New-LMDeviceDatasourceSDT [-Comment <string>] [-ScheduleWizard] [-Duration <int>]
 [-StartDate <datetime>] [-EndDate <datetime>] [-Timezone <string>] [-SdtType <string>]
 [-StartHour <int>] [-StartMinute <int>] [-EndHour <int>] [-EndMinute <int>] [-WeekDay <string[]>]
 [-WeekOfMonth <string>] [-DayOfMonth <int>] [-DeviceDataSourceId <string>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Prompts only for values not already supplied, including device and datasource selection when needed.
