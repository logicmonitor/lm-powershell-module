...
```
Get-LMWebsiteGroupSDT -Id <int> [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```

### Name

```
Get-LMWebsiteGroupSDT [-Name <string>] [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```
