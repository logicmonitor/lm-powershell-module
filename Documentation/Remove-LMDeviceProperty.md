...
```
Remove-LMDeviceProperty -Id <int> -PropertyName <string> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Name

```
Remove-LMDeviceProperty -Name <string> -PropertyName <string> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
