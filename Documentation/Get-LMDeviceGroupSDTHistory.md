...
title: Get-LMDeviceGroupSDTHistory
---
...
```
Get-LMDeviceGroupSDTHistory -Id <int> [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```

### Name

```
Get-LMDeviceGroupSDTHistory [-Name <string>] [-Filter <Object>] [-BatchSize <int>]
 [<CommonParameters>]
```
