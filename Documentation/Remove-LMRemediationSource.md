...
### Id (Default)
```
Remove-LMRemediationSource -Id <Int32> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### Name
```
Remove-LMRemediationSource -Name <String> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### -Id
Specifies the ID of the remediation source to be removed.
...
### -Name
Specifies the name of the remediation source to be removed.
This parameter is mandatory when
