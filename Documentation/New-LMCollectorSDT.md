...
```
New-LMCollectorSDT -Comment <string> [-Duration <int>] [-StartDate <datetime>] [-EndDate <datetime>]
 ...
 [-CollectorId <string>] [-CollectorName <string>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### ScheduleWizard

```
New-LMCollectorSDT [-Comment <string>] [-ScheduleWizard] [-Duration <int>] [-StartDate <datetime>]
 [-EndDate <datetime>] [-Timezone <string>] [-SdtType <string>] [-StartHour <int>]
 [-StartMinute <int>] [-EndHour <int>] [-EndMinute <int>] [-WeekDay <string[]>]
 [-WeekOfMonth <string>] [-DayOfMonth <int>] [-CollectorId <string>] [-CollectorName <string>]
...
ID of the collector.
Provide either -CollectorId or -CollectorName.
...
End date and time for one-time SDTs with a fixed window.
Requires -StartDate.
...
Start date and time for one-time SDTs.
Use with -EndDate for a fixed window, or with -Duration for a length-based SDT.
