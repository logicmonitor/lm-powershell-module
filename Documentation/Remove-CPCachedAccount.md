...
title: Remove-CPCachedAccount
---

# Remove-CPCachedAccount
...
```
Remove-CPCachedAccount -CachedAccountName <string> [-WhatIf] [-Confirm] [<CommonParameters>]
```

### All

```
Remove-CPCachedAccount [-RemoveAllEntries] [-WhatIf] [-Confirm] [<CommonParameters>]
```
