...
```
Get-LMDeviceGroupSDT -Id <int> [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```

### Name

```
Get-LMDeviceGroupSDT [-Name <string>] [-Filter <Object>] [-BatchSize <int>] [<CommonParameters>]
```
