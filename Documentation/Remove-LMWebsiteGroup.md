...
```
Remove-LMWebsiteGroup -Id <int> [-DeleteHostsandChildren <bool>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Remove-LMWebsiteGroup -Name <string> [-DeleteHostsandChildren <bool>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
