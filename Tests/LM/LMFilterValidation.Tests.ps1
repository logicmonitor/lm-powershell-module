...
Describe 'Filter Field Validation' {
    ...
    Context 'Configuration Loading' {
        It 'Should load validation config successfully' {
            $ConfigPath = "$PSScriptRoot/../../Private/LM/LMFilterValidationConfig.psd1"
...
Describe 'Filter Validation Config Generator' {
    ...
    Context 'Generated Config File' {
        It 'Should exist in Private directory' {
            "$PSScriptRoot/../../Private/LM/LMFilterValidationConfig.psd1" | Should -Exist
        }
        
        It 'Should be a valid PowerShell data file' {
            { Import-PowerShellDataFile "$PSScriptRoot/../../Private/LM/LMFilterValidationConfig.psd1" -ErrorAction Stop } | Should -Not -Throw
        }
        
        It 'Should contain hashtable structure' {
            $Config = Import-PowerShellDataFile "$PSScriptRoot/../../Private/LM/LMFilterValidationConfig.psd1"
